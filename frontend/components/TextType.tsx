...
/* TextType from React Bits (reactbits.dev), ported to TypeScript. The component's CSS rules are inline classes. */
...
export default function TextType({
  ...
  useEffect(() => {
    ...
    const blink = gsap.to(cursorRef.current, { opacity: 0, duration: cursorBlinkDuration, repeat: -1, yoyo: true, ease: "power2.inOut" });
    return () => { blink.kill(); };
