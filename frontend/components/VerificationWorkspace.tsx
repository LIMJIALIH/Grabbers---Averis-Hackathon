...
import { ShippingEmail } from '@/types/shipping';
import { ShippingVerificationView } from './ShippingVerificationView';
import { AuditTrailPanel } from './AuditTrailPanel';
import { recordUserAction, useAuditTrail } from '@/lib/auditTrailStore';
  ...
  return (
    <div className="flex flex-col h-screen w-screen bg-zinc-100 text-zinc-900 overflow-hidden font-sans">
      ...
      <header className="h-14 bg-white border-b border-zinc-200 px-5 flex items-center justify-between shrink-0 z-20">
        ...
        <div className="flex items-center gap-2">
          <Link href="/" className="text-xs font-medium underline">Dashboard</Link>
