...
the CSV so any row's label can be traced back to the rule that produced it.
    ...
    python data_prep/build_dataset.py [--bundle sdoc-hackathon-bundle] [--out data_prep/out]
"""
...
if __name__ == "__main__":
    ...
    ap.add_argument("--bundle", default="sdoc-hackathon-bundle")
    ap.add_argument("--out", default="data_prep/out")
